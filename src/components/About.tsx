...
const About: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="about" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className={`transform transition-all duration-1000 ${
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            {/* Profile Image */}
            <div className={`transform transition-all duration-1000 delay-300 order-2 lg:order-1 ${
              isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
            }`}>
              <div className="relative">
                <div className="w-64 h-64 sm:w-80 sm:h-80 mx-auto rounded-2xl overflow-hidden border-4 border-primary/30 hover:border-primary/60 transition-all duration-300">
                  <img 
                    src="/profile.jpeg" 
            ...
            {/* About Content */}
            <div className={`transform transition-all duration-1000 delay-500 order-1 lg:order-2 ${
              isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
            }`}>
              <div className="space-y-6">
                <p className="text-text-secondary text-base sm:text-lg leading-relaxed">
                  ...
                  frontend development, backend architecture, and innovative Chrome extension creation.
                </p>
                ...
                <div className="grid gap-4 mt-6 sm:mt-8">
                  {[
                    { icon: Code, title: 'Full-Stack Development', desc: 'React, Node.js, Python' },
                    { icon: Palette, title: 'UI/UX Design', desc: 'Modern, user-centric interfaces' },
                    { icon: Zap, title: 'Chrome Extensions', desc: 'Innovative browser solutions' },
                  ].map((item, index) => (
                    <div
                      key={index}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-text-secondary text-xs sm:text-sm">{item.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
