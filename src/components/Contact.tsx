...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "souravbiswas427@gmail.com" },
    { icon: Phone, label: "Phone", value: "+8801852175823" },
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/SouravBiswas238",
      label: "GitHub",
    },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/sourav03biswas/",
      label: "LinkedIn",
    },
    {
      icon: Instagram,
                  ...
                  <div className="flex space-x-4">
                    {socialLinks.map((social, index) => (
                      <a
                        key={index}
                        href={social.href}
                        className="group p-2 sm:p-3 bg-surface/30 backdrop-blur-sm rounded-xl border border-surface/50 hover:border-primary  transition-all duration-300 transform hover:scale-110"
                        aria-label={social.label}
                      >
                        <social.icon
                          size={18}
                          className="sm:w-5 sm:h-5 text-text-secondary group-hover:text-primary transition-colors duration-300"
                        />
                      </a>
                    ))}
                  </div>
