...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      id: 1,
      title: "Automate Your Sales Outreach & Growth",
      description:
        "An AI-powered sales platform that helps businesses automate lead generation, personalized outreach, and sales workflows to increase conversion rates and efficiency.",
      tech: [
        "React",
        "Python",
        "Socket.io",
      ...
      liveDemo: "https://dev.aisalesteams.com/",
      github: "",
    },
    {
      id: 7,
      ...
      image:
        "https://i.ibb.co.com/fG1693YX/Chat-GPT-Image-Sep-16-2026-12-04-38-PM.png",
      features: [
    ...
    },
    {
      ...
      features: [
        "Transparent Ledger & Fund Tracking",
        "bKash & Manual Donation Logging",
        "Expense Management with Purpose Tracking",
        "Admin Dashboard & Member Profiles",
      ],
      liveDemo: "https://goaldah-united-client.vercel.app/",
    ...
    },
    {
      ...
      features: [
        "Push Notifications for Fund Updates",
        "One-tap bKash Payment Integration",
        "Offline Member Directory Access",
        "Real-time Expense Feed",
      ],
      liveDemo:
        "https://drive.google.com/drive/folders/1IU2tB8jVqE3b1UplTMTF6vm99Bqjm5Mp?usp=sharing",
      github: "",
    },
  ...
  return (
    <section
      ref={sectionRef}
      id="projects"
      className="py-8 sm:py-12 lg:py-20 px-3 sm:px-6 lg:px-8"
    >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-surface/95 backdrop-blur-md rounded-xl border border-primary/20 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-4 sm:p-6">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3 flex-1 min-w-0 pr-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-text line-clamp-1">
              ...
              {/* Features */}
              <div className="mb-4">
                <h4 className="text-text font-semibold mb-2 text-base">
                  Key Features
                </h4>
